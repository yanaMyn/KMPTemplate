...
@Composable
private fun WalkthroughFirstPagePreview() {
...
@Composable
private fun WalkthroughMiddlePagePreview() {
    val store = remember {
...
@Composable
private fun WalkthroughLastPagePreview() {
    val store = remember {
        previewWalkthroughStore().apply {
...
@Composable
private fun WalkthroughCompletedPreview() {
    val store = remember {
        previewWalkthroughStore().apply {
